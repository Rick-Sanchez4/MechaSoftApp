...
public static class AccountEndpoints
{
    public static void RegisterAccountEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        // POST /api/accounts/register - Registrar novo usuário (público)
        ...
        // POST /api/accounts/login - Fazer login (público)
        ...
        // POST /api/accounts/forgot-password - Solicitar reset de senha (público)
        ...
        // POST /api/accounts/reset-password - Resetar senha (público)
        ...
        // POST /api/accounts/refresh-token - Renovar tokens (público para refresh)
        ...
        // GET /api/accounts/check-username/{username} - Verificar disponibilidade de username (público no registo)
        ...
        // GET /api/accounts/check-email/{email} - Verificar disponibilidade de email (público no registo)
        ...
        // GET /api/accounts/suggest-username/{username} - Sugerir usernames disponíveis (público no registo)
