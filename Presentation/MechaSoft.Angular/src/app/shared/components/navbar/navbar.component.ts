...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  systemLinks: NavLink[] = [
    ...
    {
      label: 'Veículos',
      path: '/system/vehicles',
      icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2',
    },
    {
      label: 'Ordens',
      path: '/system/service-orders',
  ...
  getAvatarColor(): string {
    ...
    const roleColors: { [key: string]: string } = {
      ...
      Employee: 'bg-gradient-to-br from-blue-500 to-blue-700',
      Customer: 'bg-gradient-to-br from-green-500 to-green-700',
    };

    return roleColors[this.currentUser.role] || 'bg-gradient-to-br from-cyan-500 to-cyan-700';
  }
